...
window.addEventListener('focus', function() {
  //console.log(timeStamp(),"Internal: ==== window is in focus again ====");
    ...
    console.log(timeStamp(),"notyf object", notyf);
});
 ...
 */
  ...
  * Format: [{ name: 'HR Port Spkr', bdAddr: 'FC:58:FA:CC:30:A4' }, ... ]
  * @param  {array} speakerArray array of objects [name: <name>, bdAddr: <bd-addr>]
  * @return {boolean}  true
  */
...
function renderDispatch(data) {
  switch(data.type) {
    ...
    break;
    case "info":
    infoDispatch(data.missive, longDuration * 10);
    break;
    case "mishap":
